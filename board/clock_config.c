...
- {id: OSCERCLK.outFreq, value: 32.768 Hz}
...
- {id: OSC.OSC.outFreq, value: 32.768 Hz, enabled: true}
...
const mcglite_config_t mcgliteConfig_BOARD_BootClockRUN =
    {
        ...
        .irclkEnableMode = kMCGLITE_IrclkEnable | kMCGLITE_IrclkEnableInStop,/* MCGIRCLK enabled as well as in STOP mode */
...
const osc_config_t oscConfig_BOARD_BootClockRUN =
    {
        .freq = 32U,                              /* Oscillator frequency: 32Hz */
